                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr style="margin-top: 5px;" id="videoslist">
                                        ...
                                        <td class="video-manager-stats" style="background: none;padding-left: 8px;">
                                            ...
                                            <span style="color: grey;font-weight:bold;">Views: </span><span style="float:right;"><?php echo $__video_h->fetch_video_views($video['rid']); ?></span><br>
                                            </span><br>

                                            <span class="video-manager-span" style="width:140px;">
                                            <span style="color: grey;font-weight:bold;">Comments: </span><span style="float:right;"><?php echo $__video_h->get_comments_from_video($video['rid']); ?></span>
                                            </span>
