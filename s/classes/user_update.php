...
class user_update {
    ...
    function update_user_bio($username, $bio) {
        $stmt = $this->__db->prepare("UPDATE users SET bio = ? WHERE username = ?");
    ...
    function update_user_country($username, $country) {
        $stmt = $this->__db->prepare("UPDATE users SET country = ? WHERE username = ?");
    ...
    function update_user_website($username, $website) {
        $stmt = $this->__db->prepare("UPDATE users SET website = ? WHERE username = ?");
    ...
    function update_user_header($username, $header) {
        $stmt = $this->__db->prepare("UPDATE users SET custom_header = ? WHERE username = ?");
    ...
    function update_user_text($username, $text) {
        $stmt = $this->__db->prepare("UPDATE users SET custom_text = ? WHERE username = ?");
    ...
    function update_user_genre($username, $genre) {
        $stmt = $this->__db->prepare("UPDATE users SET genre = ? WHERE username = ?");
    ...
    function update_user_css($username, $css) {
        $stmt = $this->__db->prepare("UPDATE users SET css = ? WHERE username = ?");
    ...
    function update_user_channels($username, $bio) {
        $stmt = $this->__db->prepare("UPDATE users SET featured_channels = ? WHERE username = ?");
        $stmt->bind_param("ss", $bio, $username);
        $stmt->execute();
        $stmt->close();
    ...
    function update_user_transparency($username, $percentage) {
        $stmt = $this->__db->prepare("UPDATE users SET transparency = ? WHERE username = ?");
    ...
    function update_user_margin_top($username, $type) {
        $stmt = $this->__db->prepare("UPDATE users SET bannerdp = ? WHERE username = ?");
    ...
    function update_user_featured_video($username, $bio) {
        $stmt = $this->__db->prepare("UPDATE users SET featured = ? WHERE username = ?");
        $stmt->bind_param("ss", $bio, $username);
        $stmt->execute();
        $stmt->close();
    ...
    function update_user_featured_title($username, $bio) {
        $stmt = $this->__db->prepare("UPDATE users SET customchannelfeatured = ? WHERE username = ?");
        $stmt->bind_param("ss", $bio, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_primary_color($username, $type) {
        $stmt = $this->__db->prepare("UPDATE users SET primary_color = ? WHERE username = ?");
        $stmt->bind_param("ss", $type, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_border_color($username, $color) {
        $stmt = $this->__db->prepare("UPDATE users SET border_color = ? WHERE username = ?");
    ...
    function update_user_secondary_color($username, $type) {
        $stmt = $this->__db->prepare("UPDATE users SET secondary_color = ? WHERE username = ?");
        $stmt->bind_param("ss", $type, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_third_color($type, $username) {
        $stmt = $this->__db->prepare("UPDATE users SET third_color = ? WHERE username = ?");
        $stmt->bind_param("ss", $type, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_bg_option($type, $username) {
        $stmt = $this->__db->prepare("UPDATE users SET 2012_bgoption = ? WHERE username = ?");
        $stmt->bind_param("ss", $type, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_bg_color($color, $username) {
        $stmt = $this->__db->prepare("UPDATE users SET 2012_bgcolor = ? WHERE username = ?");
        $stmt->bind_param("ss", $color, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_bg($color, $username) {
        $stmt = $this->__db->prepare("UPDATE users SET 2012_bg = ? WHERE username = ?");
        $stmt->bind_param("ss", $color, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_bg_option_09($type, $username) {
        $stmt = $this->__db->prepare("UPDATE users SET 2009_bgoption = ? WHERE username = ?");
        $stmt->bind_param("ss", $type, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_bg_color_09($color, $username) {
        $stmt = $this->__db->prepare("UPDATE users SET 2009_bgcolor = ? WHERE username = ?");
        $stmt->bind_param("ss", $color, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_bg_09($color, $username) {
        $stmt = $this->__db->prepare("UPDATE users SET 2009_bg = ? WHERE username = ?");
        $stmt->bind_param("ss", $color, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_banner($color, $username) {
        $stmt = $this->__db->prepare("UPDATE users SET banner = ? WHERE username = ?");
        $stmt->bind_param("ss", $color, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_video_banner($color, $username) {
        $stmt = $this->__db->prepare("UPDATE users SET subbutton = ? WHERE username = ?");
        $stmt->bind_param("ss", $color, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_text_color($username, $type) {
        $stmt = $this->__db->prepare("UPDATE users SET text_color = ? WHERE username = ?");
        $stmt->bind_param("ss", $type, $username);
        $stmt->execute();
    $stmt->close();
    ...
    function update_user_primary_text_color($username, $type) {
        $stmt = $this->__db->prepare("UPDATE users SET primary_color_text = ? WHERE username = ?");
        $stmt->bind_param("ss", $type, $username);
        $stmt->execute();
    $stmt->close();
