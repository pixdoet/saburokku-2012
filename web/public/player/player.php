...
$image = "/dynamic/thumbs/" . $_video['thumbnail']; // set this for thumbnail
$name = urlencode(htmlspecialchars($_video['title'])); // self-explanatory
?>
  <html lang="en" dir="ltr">

<head>

    <link rel="stylesheet" href="/s/player/player.css">
  <style>
...
Advertisement
  ...
  <div id="player" class="full-frame"></div>
    ...
    <script src="/s/player/embed.js" data-loaded="true"></script>
